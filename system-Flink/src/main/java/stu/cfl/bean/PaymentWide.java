...
public class PaymentWide {
    ...
    String province_name;	//查询维表得到String province_area_code;
    ...
    Long tm_id;
    Long category3_id; String spu_name; String tm_name;
    ...
    public void mergePaymentInfo(PaymentInfo paymentInfo) {
        if (paymentInfo != null) {
            try {
                ...
                payment_create_time = paymentInfo.create_time; payment_id = paymentInfo.id;
